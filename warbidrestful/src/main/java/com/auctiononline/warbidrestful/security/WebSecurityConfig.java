    ...
    http.csrf(csrf -> csrf.disable())
        ...
        .authorizeHttpRequests(auth -> 
          auth.requestMatchers("/api/test/**").permitAll()
                  ...
                  .requestMatchers("/api/post/private/**").authenticated()
                  .requestMatchers("/api/product/public/**").permitAll()
                  .requestMatchers("/api/product/private/**").authenticated()
                  .requestMatchers("/api/feedback/public/**").permitAll()
                  .requestMatchers("/api/feedback/private/**").authenticated()
                  .requestMatchers("/api/auction/public/**").permitAll()
                  .requestMatchers("/api/auction/private/**").authenticated()
                  .requestMatchers("/api/category/public/**").permitAll()
                  .requestMatchers("/api/category/private/**").authenticated()
